...
import static lab3.main.ChartCreator.Type.FIST_LAW_ZIPF;
import static lab3.main.ChartCreator.Type.SECOND_LAW_ZIPF;
...
public class ChartCreator {
    ...
    getMap(Map<String, WordStatistic> allDate, Type type) {
        ...
        switch (type) {
            case FIST_LAW_ZIPF:
                Map<Long, Float> result1 = new LinkedHashMap<>();
            ...
            case SECOND_LAW_ZIPF:
                Map<Float, Long> result2 = new LinkedHashMap<>();
