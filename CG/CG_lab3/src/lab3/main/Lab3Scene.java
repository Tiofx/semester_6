...
import lab2.main.Lab2Scene;
import lab2.main.figures.Quad;
import lab2.main.figures.Vertex3f;

import static lab2.main.figures.Axis.fontScale;
import static lab2.main.figures.Axis.textRenderer;
...
public class Lab3Scene extends Lab2Scene {
    ...
    public Lab3Scene() {
        ...
        color = new float[]{0.5f, 0.3f, 0.1f};
